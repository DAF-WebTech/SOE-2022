...
document.addEventListener("DOMContentLoaded", function () {
	...
	new Vue({
		...
		computed: {
			heading1: () => "Construction and demolition waste recovered",
			heading2: () => "Trend in total construction and demolition waste recovered",
			heading3: () => `Proportion of construction and demolition waste recovered by material, ${latestYear.replace("-", "–")}`, //ndash
		},
		methods: {
